...
_VALID_TRANSITIONS: dict[ErcLifecycleStatus, frozenset[ErcLifecycleStatus]] = {
    ...
    ErcLifecycleStatus.COLLECTING: frozenset(
        {ErcLifecycleStatus.NORMALIZING, ErcLifecycleStatus.FAILED}
    ),
    ErcLifecycleStatus.NORMALIZING: frozenset(
        {ErcLifecycleStatus.AGGREGATING, ErcLifecycleStatus.FAILED}
    ),
    ErcLifecycleStatus.AGGREGATING: frozenset(
        {ErcLifecycleStatus.VALIDATING, ErcLifecycleStatus.FAILED}
    ),
    ErcLifecycleStatus.VALIDATING: frozenset(
        {ErcLifecycleStatus.READY, ErcLifecycleStatus.INVALID, ErcLifecycleStatus.FAILED}
    ),
    ErcLifecycleStatus.READY: frozenset(
        {ErcLifecycleStatus.REFRESH_REQUIRED, ErcLifecycleStatus.STALE}
    ),
    ...
    ErcLifecycleStatus.STALE: frozenset(
        {ErcLifecycleStatus.REFRESH_REQUIRED, ErcLifecycleStatus.REFRESHING}
    ),
