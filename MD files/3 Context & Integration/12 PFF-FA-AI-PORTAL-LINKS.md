# PFF-FA Enterprise Agentic AI Platform — Portal Links

**Document ID:** PFF-FA-AI-PORTAL-LINKS  
...
This document defines the portal-link architecture for the PFF-FA Enterprise Agentic AI Platform.
...
It should be capable of returning controlled, validated, user-appropriate navigation links to the existing PFF-FA enterprise portals.
