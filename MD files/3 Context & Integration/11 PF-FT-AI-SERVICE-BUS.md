# PF-FT Enterprise Agentic AI Platform — Service Bus & Event Integration

**Document ID:** PF-FT-AI-SERVICE-BUS  
...
This document defines the asynchronous event architecture for the PF-FT Enterprise Agentic AI Platform.
...
Human-in-the-loop events are important for PF-FT workflows.
...
```yaml
subscription:
  name: pf-ft-ai-runtime
  topic: pf-ft-enterprise-events
