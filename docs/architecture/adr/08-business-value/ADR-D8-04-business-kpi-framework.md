...
(ADR-D7-07) (doc 20 §15, §87–§88; doc 26 §78). KPIs are outcome-focused and tied to the ROI
model (ADR-D8-03).

## 2. Context and Problem Statement

Doc 20 §15 AI suitability/benefit, §87–§88 governance metrics/dashboard; doc 26 §78 cost per
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Outcome-focused business KPIs | doc 20 §15; doc 26 §78 |
| DR-F-02 | Business dashboard | doc 20 §88 |
...
cost per outcome (ADR-D8-01); on a business dashboard (doc 20 §88); feeding ROI (ADR-D8-03);
...
|---|---|
| No business KPIs | doc 20 §15/§87 |
| Vanity-only KPIs | Not outcome-focused |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by doc 20 §15/§87–§88 and doc 26 §78.
...
- KPIs computed from platform telemetry (ADR-D7-01), enterprise outcomes (completion), and
  cost (ADR-D8-01); business dashboard (doc 20 §88) with targets/trends and county/segment
  slices; feeds ROI (ADR-D8-03) and governance review (doc 20 §90).
...
| Specification sections | doc 20 §15, §87–§88; doc 26 §78 |
