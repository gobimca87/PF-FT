...
back (doc 20 §29, §115–§116). This ADR governs the `_register/` artefacts created by the ADR
programme (ADR-D0-01).

## 2. Context and Problem Statement

Doc 20 §29 traceability, §115 governance traceability matrix, §116 governance DoD. The ADR
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Central decision register (all ADRs) | doc 20 §115; ADR-D0-01 |
| DR-F-02 | Traceability: WS↔doc↔req↔phase↔code | doc 20 §29, §115 |
...
|---|---|
| No register | doc 20 §115; ADR-D0-01 |
| Traceability by memory | Unauditable |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by doc 20 §29/§115–§116 and the ADR
...
| Specification sections | doc 20 §29, §115–§116 |
