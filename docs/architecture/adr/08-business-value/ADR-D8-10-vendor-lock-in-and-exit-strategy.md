...
its keep (doc 20 §95–§97; DEVELOPMENT-GUIDE §2). Portability is engineered where it matters
(SLM, embeddings, vector store, observability), not pursued everywhere at cost.

## 2. Context and Problem Statement

Doc 20 §95–§97 third-party AI governance/provider-change/exit-strategy; DEVELOPMENT-GUIDE §2
...
| DR-F-02 | Documented exit strategy per major dependency | doc 20 §97 |
...
(ADR-D8-02); a documented exit strategy per major dependency (doc 20 §97); deliberate
...
|---|---|
| No exit strategy | doc 20 §97 |
| Abstract nothing | Strategic lock-in risk |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by doc 20 §95–§97 and DEVELOPMENT-GUIDE §2.
...
- Per-dependency exit strategy (doc 20 §97): what it is, switching cost, alternative, data-export
...
| Specification sections | doc 20 §95–§97; DEVELOPMENT-GUIDE §2 |
