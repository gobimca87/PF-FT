...
source_docs:
  - "MD files/6 Production/26.PFF-FA-AI-PERFORMANCE-COST.md §74, §75, §76, §77, §78, §79, §80, §88, §89, §90, §91, §92, §93, §95"
build_phases: [20]
impacted_paths:
...
(26.PFF-FA-AI-PERFORMANCE-COST.md §74–§93, §95). The headline metric is **cost per successful workflow completion**
(e.g. per completed affiliation), because that ties spend to delivered value; token/GPU/
infra costs roll up into it.

## 2. Context and Problem Statement

26.PFF-FA-AI-PERFORMANCE-COST.md §74–§75 cost model/categories, §76–§79 cost per request/workflow/outcome/user,
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Cost per request/workflow/outcome | 26.PFF-FA-AI-PERFORMANCE-COST.md §76–§78 |
| DR-F-02 | Cost attribution + tags | 26.PFF-FA-AI-PERFORMANCE-COST.md §88–§89 |
| DR-F-03 | Budgets + alerts + anomaly detection | 26.PFF-FA-AI-PERFORMANCE-COST.md §90–§92 |
| DR-F-04 | Tie cost to value (successful outcome) | 26.PFF-FA-AI-PERFORMANCE-COST.md §78; ADR-D8-03 |
...
via cost tags (26.PFF-FA-AI-PERFORMANCE-COST.md §89) and Langfuse token/cost traces (ADR-D7-02); budgets + alerts
...
**Description.** Option A plus a FinOps dashboard, a cost-regression gate in CI (26.PFF-FA-AI-PERFORMANCE-COST.md
...
|---|---|
| No cost tracking | 26.PFF-FA-AI-PERFORMANCE-COST.md §74 |
| Estimate-only (no measurement) | Not actionable |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by 26.PFF-FA-AI-PERFORMANCE-COST.md §74–§95/§132/§135.
...
- Cost computed from Langfuse token/cost traces (ADR-D7-02) + cloud cost tags (26.PFF-FA-AI-PERFORMANCE-COST.md §89);
...
|---|---|
| Build phases | 20 |
| Repository paths | `src/pff_fa_ai/observability/` (cost) + dashboards |
...
| Specification sections | 26.PFF-FA-AI-PERFORMANCE-COST.md §74–§98, §132, §135 |
