...
source_docs:
  - "MD files/3 Context & Integration/12 PFF-FA-AI-PORTAL-LINKS.md §2, §7, §8, §9, §10, §14, §16, §17, §18, §20, §25, §26, §27, §28, §29, §30, §31, §32, §39, §40, §42, §43, §46, §47, §48, §49, §50, §55, §56"
...
templates, never generated by the model and never validated after the fact. 12 PFF-FA-AI-PORTAL-LINKS.md §27's "SLM must
...
12 PFF-FA-AI-PORTAL-LINKS.md covers portal links across sixty sections. §25 requires link generation to be deterministic;
...
chat history. 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §48 lists SLM-generated URLs among the anti-patterns.
...
URL and validates it against allowed domains (12 PFF-FA-AI-PORTAL-LINKS.md §31–§32). That is weaker than it looks: an
attacker-influenced URL on an allowed domain passes, and a plausible-but-nonexistent path on the
right domain also passes.

**How much does the model participate?** 12 PFF-FA-AI-PORTAL-LINKS.md §26 gives the SLM a role in link generation
...
**What happens to links in history?** 12 PFF-FA-AI-PORTAL-LINKS.md §50 raises expiry interacting with chat history. A
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | The SLM must not generate URLs | 12 PFF-FA-AI-PORTAL-LINKS.md §27; 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §48 |
| DR-F-02 | Link generation must be deterministic | 12 PFF-FA-AI-PORTAL-LINKS.md §25 |
| DR-F-03 | Environment URLs must not be hard-coded in agent code | 12 PFF-FA-AI-PORTAL-LINKS.md §8–§9 |
| DR-F-04 | Links must be validated for scheme, domain, path and parameters | 12 PFF-FA-AI-PORTAL-LINKS.md §30–§36 |
| DR-F-05 | Entity and workflow ownership must be validated | 12 PFF-FA-AI-PORTAL-LINKS.md §42–§43 |
| DR-F-06 | Expired links must be handled, including in history | 12 PFF-FA-AI-PORTAL-LINKS.md §48–§50 |

### 3.2 Non-functional drivers

| ID | Driver | Target | Source |
|---|---|---|---|
| DR-N-01 | A user must never be sent to a broken link | 0 broken links emitted | 12 PFF-FA-AI-PORTAL-LINKS.md §55–§56 |
| DR-N-02 | Environment safety — no cross-environment links | 0 occurrences | 12 PFF-FA-AI-PORTAL-LINKS.md §10 |
...
| DR-C-03 | Authorization is enterprise-owned; a link is not an authorization | Platform | 12 PFF-FA-AI-PORTAL-LINKS.md §39–§40 |
...
| DR-A-02 | Portal routes are stable enough that the catalogue does not churn | Route maintenance becomes significant | 12 PFF-FA-AI-PORTAL-LINKS.md §58's deprecation handling; QM-05 |
...
domain against an allowlist (12 PFF-FA-AI-PORTAL-LINKS.md §31–§32) and passes what matches.
...
**Weaknesses.**
- Contradicts 12 PFF-FA-AI-PORTAL-LINKS.md §27 and 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §48 directly.
...
- Deterministic, satisfying 12 PFF-FA-AI-PORTAL-LINKS.md §25.
- Directly implements 12 PFF-FA-AI-PORTAL-LINKS.md §28–§29's resolver and registry.
...
- The model still generates URLs, which 12 PFF-FA-AI-PORTAL-LINKS.md §27 forbids regardless of what happens next.
...
Per 12 PFF-FA-AI-PORTAL-LINKS.md §8, no environment URL appears in agent code — bases are configuration resolved per
environment (12 PFF-FA-AI-PORTAL-LINKS.md §9), which is what delivers DR-N-02.

### 7.2 The model references a route, it does not write a URL

12 PFF-FA-AI-PORTAL-LINKS.md §26 gives the SLM a role. That role is **selecting which destination is relevant**, not
...
12 PFF-FA-AI-PORTAL-LINKS.md §30–§36's validator still exists and runs at *construction* time — scheme, domain, path
...
Per 12 PFF-FA-AI-PORTAL-LINKS.md §39–§43, a link is not an authorization (DR-C-03). But constructing a link to a resource
the user cannot access is a poor experience and leaks the resource's existence.

At construction, the resolver validates:

- **Entity ownership** (12 PFF-FA-AI-PORTAL-LINKS.md §42) — the club, team or application belongs to the user's scope.
- **Workflow ownership** (12 PFF-FA-AI-PORTAL-LINKS.md §43) — the workflow instance is the user's.
- **Tenant isolation** (12 PFF-FA-AI-PORTAL-LINKS.md §41) — county and organisation boundaries.
...
12 PFF-FA-AI-PORTAL-LINKS.md §46–§50 cover signed links. Where a route requires one (DR-A-03, per-route assessment), the
resolver signs it with a bounded expiry (12 PFF-FA-AI-PORTAL-LINKS.md §48).

12 PFF-FA-AI-PORTAL-LINKS.md §50's history problem: a signed link in a conversation the user reopens after expiry.
Handling:
...
Per 12 PFF-FA-AI-PORTAL-LINKS.md §55–§58, routes break and portals migrate. Three provisions:

- **Route health checks** (12 PFF-FA-AI-PORTAL-LINKS.md §57) verify catalogued routes resolve, on a schedule against
  each environment, so a broken route is found before a user meets it.
- **Deprecation** (12 PFF-FA-AI-PORTAL-LINKS.md §58) marks a route superseded, with the resolver preferring its
  replacement.
...
flowchart TD
    ...
    R -- Yes --> V{Parameters valid?<br/>12 PFF-FA-AI-PORTAL-LINKS.md §34-§36}
    V -- No --> W
    V -- Yes --> O{Ownership + tenant<br/>12 PFF-FA-AI-PORTAL-LINKS.md §41-§43}
...
- 12 PFF-FA-AI-PORTAL-LINKS.md §30–§36's validator still runs, at construction rather than as the primary control.
...
|---|---|---|---|---|---|---|---|
| RSK-01 | A code path emits a URL outside the resolver | Low | Very High | High | §7.3's stripping catches it regardless of origin; QM-01; no hard-coded URLs (12 PFF-FA-AI-PORTAL-LINKS.md §8) | Security Owner | Low |
...
| RSK-03 | A catalogued route breaks after a portal change (DR-A-02) | Medium | Medium | Medium | Route health checks (12 PFF-FA-AI-PORTAL-LINKS.md §57); deprecation handling; QM-05 | Operations/SRE | Low |
| RSK-04 | A cross-environment link is emitted | Low | High | Medium | Base URLs are per-environment configuration; 12 PFF-FA-AI-PORTAL-LINKS.md §10; QM-03 | AI Engineering Lead | Low |
...
| Repository paths | `src/pff_fa_ai/portal_links/` — models, catalog, registry, route_registry, resolver, validator, security, expiration, signed_links, entity_links, workflow_links, ui_contract |
| Configuration | Portal bases per environment; route catalogue; signing keys via `*_secret_ref` (ADR-D5-07) |
| Contracts / schemas | Route template model; constructed-link record; UI contract (12 PFF-FA-AI-PORTAL-LINKS.md) |
| Migration | None |
...
| AC-02 | No URL literal appears in agent or prompt code | Static analysis for URL patterns; 12 PFF-FA-AI-PORTAL-LINKS.md §8 |
...
| Route health checks | ~0.5 day | Scheduled runs per environment | 12 PFF-FA-AI-PORTAL-LINKS.md §57 |
...
| RT-05 | Portal migration announced (12 PFF-FA-AI-PORTAL-LINKS.md §59) | Enterprise notice | Update bases and routes; health checks verify before switchover |
