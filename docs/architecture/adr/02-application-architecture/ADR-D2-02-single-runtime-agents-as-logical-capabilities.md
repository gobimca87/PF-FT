...
source_docs:
  ...
  - "MD files/6 Production/25.PF-FT-AI-INFRASTRUCTURE-OPERATIONS.md §12, §13, §20"
build_phases: [4, 19]
impacted_paths:
  - src/pf_ft_ai/agents/
...
`AffiliationAgent` is a package under `src/pf_ft_ai/agents/`. It is invoked by an in-process
...
| Repository paths | `src/pf_ft_ai/agents/`, `src/pf_ft_ai/orchestration/`, `Dockerfile` |
