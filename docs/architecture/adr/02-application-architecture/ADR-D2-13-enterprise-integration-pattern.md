...
source_docs:
  - "MD files/3 Context & Integration/10 PF-FT-AI-ENTERPRISE-INTEGRATION.md §2, §4, §5, §6, §7, §25, §26, §27, §28, §29, §30, §31, §32, §33"
  - "MD files/1 Foundation/1 PF-FT-AI-ARCHITECTURE.md §16, §17"
  - "MD files/1 Foundation/2. PF-FT-AI-ARCHITECTURE-DETAILED.md §18, §19, §20"
build_phases: [6]
impacted_paths:
...
| Repository paths | `src/pf_ft_ai/integration/api/`, `tools/`, `mcp/`, `execution/`, `errors/` |
