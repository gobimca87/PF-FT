...
source_docs:
  ...
  - "MD files/1 Foundation/1 PFF-FA-AI-ARCHITECTURE.md §40"
  - "MD files/5 QualityGovernance/20.PFF-FA-AI-GOVERNANCE.md §29, §30, §113, §114, §115"
  - "MD files/1 Foundation/3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §46, §73"
build_phases: [0, 21]
impacted_paths:
...
the codebase without the traceable evidence that 20.PFF-FA-AI-GOVERNANCE.md §29, §30 and §115 require.
...
- **Missing compliance evidence.** 20.PFF-FA-AI-GOVERNANCE.md §29 (Traceability) and §30 (Auditability)
...
2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 addresses architecture governance directly and says the opposite of what this
ADR concludes:
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Every architecturally significant decision must be discoverable by an engineer working in the repository | 20.PFF-FA-AI-GOVERNANCE.md §113 (AI Documentation Governance) |
...
| DR-F-04 | The decision record must support supersession, so architecture can evolve without losing history | 20.PFF-FA-AI-GOVERNANCE.md §73 (Version Governance), 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §73 (Change Control) |
| DR-F-05 | Decisions must be traceable to requirements, implementation, tests and evidence | 20.PFF-FA-AI-GOVERNANCE.md §115 |

### 3.2 Non-functional drivers

| ID | Driver | Target | Source |
|---|---|---|---|
| DR-N-01 | Auditability — an assessor can retrieve the rationale for any decision without interviewing the author | 100% of Accepted ADRs carry a completed §4–§7 | 20.PFF-FA-AI-GOVERNANCE.md §30 |
| DR-N-02 | Currency — records reflect the system as built, not as first imagined | No Accepted ADR past its `review_due` by more than one quarter | 20.PFF-FA-AI-GOVERNANCE.md §114 |
...
|---|---|---|---|
| DR-C-01 | An external ADF/ADR governance process exists above this repository and retains authority over cross-programme architecture | Organisational | 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 |
...
| DR-C-03 | Changes affecting system boundaries, data ownership, agent architecture, LangGraph, ERC, SLM, security, tools/MCP, eventing, state, AI evaluation or deployment boundaries must pass the agreed architecture governance process | Organisational | 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 |
...
|---|---|---|---|---|
| EC-01 | Auditability and compliance evidence | 25 | 20.PFF-FA-AI-GOVERNANCE.md §29, §30 and §115 make traceable, auditable decisions a governance obligation, not a nicety; this is the single largest driver | Can an assessor retrieve criteria, alternatives, rationale and approver for an arbitrary decision without interviewing anyone? |
| EC-02 | Proximity to the code the decision governs | 20 | Determines whether decisions are actually read at the moment they matter | Distance in steps from an engineer editing `src/pff_fa_ai/` to the governing rationale |
...
| EC-06 | Alignment with existing organisational process | 8 | 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 places authority in an external forum; friction there has real cost | Degree of conflict with DR-C-01 and DR-C-03 |
| | **Total** | **100** | | |
...
### 5.1 Option A — External ADF/ADR process only, as 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 directs
...
**Strengths.**
- Exactly what 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 specifies; zero conflict with organisational process.
...
**Weaknesses.**
- An engineer changing `src/pff_fa_ai/orchestration/` has no local signal that a decision
  governs what they are about to change. This is the failure mode that produced the
  twelve anti-patterns in 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §48 in the first place.
...
- Produces no repository-local evidence for 20.PFF-FA-AI-GOVERNANCE.md §115's traceability chain.
...
- Produces exactly the evidence 20.PFF-FA-AI-GOVERNANCE.md §29, §30 and §115 require, in the repository, under
...
- Conflicts with 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 as written, requiring the exception this ADR constitutes.
...
external process: decisions touching the categories 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 enumerates are drafted in the
...
- Resolves the conflict with 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 rather than overriding it: the external process
...
and EC-04 are grounded in the specific requirements of 20.PFF-FA-AI-GOVERNANCE.md §29, §30, §115 and CMMI-DEV
DAR SP 1.1–1.5. EC-02 and EC-05 are assessed from the delivery team's experience with the
existing `docs/adr/` records. EC-06 is assessed against the literal text of 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52.
...
- The repository library is the **record** for every architecture decision in this
  programme.
- Decisions touching the categories enumerated in 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 — system boundaries, data
...
only option that resolves the conflict with 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 rather than either ignoring it
...
The departure from 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 is recorded, deliberate and bounded. It is registered as a
governance exception per 20.PFF-FA-AI-GOVERNANCE.md §101–§102:
...
exception:
  ...
  reason: >
    2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 states the application repository does not require an ADR folder.
    An in-repository library is adopted because 20.PFF-FA-AI-GOVERNANCE.md §29, §30 and §115 require
    traceable, auditable decision evidence that an external-only process does not
    produce at repository level.
  risk: LOW
  compensating_controls:
    - External ADF/ADR forum retains ratification authority over all 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 categories
...
Per 20.PFF-FA-AI-GOVERNANCE.md §103, this exception is not permanent by intent: if the external forum
subsequently extends its process to hold repository-level decisions natively, the correct
response is to update the policy — amend 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 through its own change control — rather
than leave the exception open indefinitely.

**Status rationale.** Accepted. The decision is within the AI Solution Architect's
authority under ADR-D0-03 (it concerns how decisions are recorded, not any of the 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md
...
| §19 Traceability | 20.PFF-FA-AI-GOVERNANCE.md §115 | Broken requirement-to-evidence chain |
...
flowchart TD
    ...
    D --> E{Touches a 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 category?}
...
- 20.PFF-FA-AI-GOVERNANCE.md §115's traceability chain gains its architecture link, in version control, with
...
- The twelve anti-patterns in 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §48 gain the reasoning that turns a prohibition into
...
| Literal conformance with 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 | Repository-level decision evidence required by 20.PFF-FA-AI-GOVERNANCE.md §29, §30, §115 | AI Solution Architect, pending external forum confirmation |
...
|---|---|---|---|---|---|---|---|
| RSK-01 | External ADF/ADR forum rejects the in-repository library, making the 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 exception invalid | Low | High | Medium | Raise GOV-EX-ADR-001 at the next forum; the library is the record either way, so rejection changes ratification routing, not the artefacts | AI Solution Architect | Low |
...
| Audit and evidential requirements | Positive and substantial — this is the decision's primary purpose. Satisfies 20.PFF-FA-AI-GOVERNANCE.md §29 (Traceability), §30 (Auditability) and supplies the architecture link in the §115 chain. |
...
anti-pattern from 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §48 reaching production and being unwound, exceeds a year of the
...
| RT-02 | 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 is amended through its own change control | Change notice on `MD files/` | Re-evaluate; if §52 now provides for repository decisions, retire the exception per 20.PFF-FA-AI-GOVERNANCE.md §103 |
...
| Specification sections | 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52 (Architecture Governance — the conflict this ADR resolves), §48 (Anti-Patterns); 1 PFF-FA-AI-ARCHITECTURE.md §40 (Architecture Governance); 20.PFF-FA-AI-GOVERNANCE.md §29 (Traceability), §30 (Auditability), §101–§103 (Exceptions), §113 (Documentation Governance), §114 (Documentation Version), §115 (Traceability Matrix); 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §46 (Decision Authority Matrix), §73 (Change Control) |
...
|---|---|---|---|
| 1.0.0 | 2026-08-21 | AI Solution Architect | Initial decision recorded. Adopts the in-repository library under the hybrid ratification model; registers exception GOV-EX-ADR-001 against 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §52. |
