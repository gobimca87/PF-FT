...
source_docs:
  - "MD files/6 Production/25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §33, §34, §35, §36, §37, §38, §39, §40, §41"
  - "MD files/4 AI/17.PFF-FA-AI-CONFIGURATION-VERSIONING.md §13, §16"
build_phases: [1]
impacted_paths:
  - config/
  - infra/
...
users (25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §33–§41; 17.PFF-FA-AI-CONFIGURATION-VERSIONING.md §13). Each environment is isolated (network, data,
identity); promotion is by the immutable release manifest (ADR-D5-06).

## 2. Context and Problem Statement

25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §33–§38 define the five environments, §39 environment isolation, §40–§41
configuration; 17.PFF-FA-AI-CONFIGURATION-VERSIONING.md §13/§16 environment configuration and isolation. CLAUDE.md/
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Progressive stages to production | 25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §33–§38 |
| DR-F-02 | Strict env isolation (net/data/identity) | 25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §39; 17.PFF-FA-AI-CONFIGURATION-VERSIONING.md §16 |
| DR-F-03 | Per-env config overlays | 25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §40; ADR-D5-06 |
...
testing; 25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md specifies five.
...
**Method.** Weighted scoring against §4, informed by 25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §33–§41 and 17.PFF-FA-AI-CONFIGURATION-VERSIONING.md §13/§16.
...
**Status rationale.** `Accepted` — 25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §33–§38 define the five stages.

## 8. Architecture Detail

- Environments: DEV (integration), TEST (automated QA), UAT (business sign-off), STAGE
  (prod-mirror/perf/security window), PROD (25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §34–§38).
...
| Specification sections | 25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §33–§41; 17.PFF-FA-AI-CONFIGURATION-VERSIONING.md §13, §16 |
| Requirement IDs | ENV-* |
| Build phases | 1 |
