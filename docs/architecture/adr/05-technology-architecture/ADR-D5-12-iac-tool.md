...
Doc 25 §42–§44 require infrastructure-as-code with a defined structure and principles;
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Declarative IaC for all Azure resources | doc 25 §42–§44 |
| DR-F-02 | Plan/preview + review before apply | doc 25 §44 |
| DR-N-01 | Module reuse across 5 environments | doc 25 §33–§38; ADR-D5-14 |
| DR-N-02 | State management + drift detection | doc 25 §44 |
...
|---|---|
| Manual portal/CLI provisioning | doc 25 §42 — must be IaC |
...
- `infra/` holds IaC modules per resource group/service (doc 25 §43); environments
...
| Specification sections | doc 25 §42–§44 |
