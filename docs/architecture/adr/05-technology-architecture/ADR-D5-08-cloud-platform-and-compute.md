...
(CLAUDE.md; doc 25 §3–§4, §10). AKS gives the container orchestration, GPU node pools
(ADR-D5-11), private networking and workload separation the platform needs while
staying inside the FA's Azure tenancy.

## 2. Context and Problem Statement

CLAUDE.md fixes Azure + AKS; doc 25 §3–§4 describe the target Azure architecture,
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Container orchestration with GPU node pools | doc 25 §10, §20–§21; ADR-D5-11 |
| DR-F-02 | Private connectivity to enterprise + PaaS | doc 25 §22–§24; ADR-D6-04 |
| DR-C-01 | Stay in the FA's Azure tenancy | CLAUDE.md; organisational |
| DR-N-01 | HA, autoscaling, workload separation | doc 25 §12, §52, §54 |
...
SLM and fine-grained workload separation (doc 25 §12, §21).
...
**Method.** Weighted scoring against §4, informed by CLAUDE.md and doc 25 §3–§22.
...
**Status rationale.** `Accepted` — confirmed in CLAUDE.md and doc 25.

## 8. Architecture Detail

- AKS cluster with node pools: system, CPU workload, GPU workload (doc 25 §12, §20–§21);
...
| Specification sections | doc 25 §3–§4, §9–§12, §20–§25, §54 |
