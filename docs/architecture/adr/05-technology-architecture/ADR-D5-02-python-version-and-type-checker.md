...
Pydantic-plugin support and ecosystem alignment (doc 27 §13–§14).

## 2. Context and Problem Statement

Doc 27 §9 requires a pinned Python version range; §13–§14 require static type checking
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Pinned, supported Python range | doc 27 §9 |
| DR-F-02 | One primary strict type checker | CLAUDE.md; doc 27 §13 |
| DR-F-03 | First-class Pydantic v2 typing | doc 27 §16; ADR-D5-03 |
| DR-N-01 | CI + pre-commit consistency | doc 27 §12–§13 |
...
**Weaknesses.** Loses the correctness benefit; violates doc 27 §13.
...
|---|---|
| Python ≤3.10 | Misses 3.11+ typing/perf; doc 27 §9 |
| Pyre/other checkers | Smaller ecosystem than mypy/pyright |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by doc 27 §9/§13–§16 and CLAUDE.md.
...
- `pyproject.toml`: `requires-python = ">=3.11,<3.13"`; `[tool.mypy]` strict with
  `plugins = ["pydantic.mypy"]`; CI job `mypy src` (doc 27 §13); pre-commit hook.
- Typed domain objects and Pydantic at boundaries (doc 27 §14–§16; ADR-D5-03).
...
| Specification sections | doc 27 §9, §13–§16 |
