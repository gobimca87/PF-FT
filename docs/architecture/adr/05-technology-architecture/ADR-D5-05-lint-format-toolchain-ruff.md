...
source_docs:
  - "MD files/6 Production/27.PFF-FA-AI-DEVELOPMENT-STANDARDS.md §11, §12, §23"
build_phases: [0]
impacted_paths:
  - pyproject.toml
...
replacing the traditional flake8 + isort + black (+ plugins) stack (CLAUDE.md; 27.PFF-FA-AI-DEVELOPMENT-STANDARDS.md
...
rules (27.PFF-FA-AI-DEVELOPMENT-STANDARDS.md §23).

## 2. Context and Problem Statement

CLAUDE.md fixes "Ruff" for lint/format; 27.PFF-FA-AI-DEVELOPMENT-STANDARDS.md §11 sets formatting, §12 linting, §23
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Single lint+format tool | CLAUDE.md; 27.PFF-FA-AI-DEVELOPMENT-STANDARDS.md §11–§12 |
| DR-N-01 | Fast (pre-commit + CI) | operational |
| DR-F-02 | Import sorting + rule coverage | 27.PFF-FA-AI-DEVELOPMENT-STANDARDS.md §12, §23 |
...
**Weaknesses.** Inconsistent style; diff noise; 27.PFF-FA-AI-DEVELOPMENT-STANDARDS.md §11 wants formatting.
...
**Method.** Weighted scoring against §4, informed by CLAUDE.md and 27.PFF-FA-AI-DEVELOPMENT-STANDARDS.md §11–§12/§23.
...
sorting and magic-number rules (27.PFF-FA-AI-DEVELOPMENT-STANDARDS.md §23), configured in `pyproject.toml` and run in
...
| Specification sections | 27.PFF-FA-AI-DEVELOPMENT-STANDARDS.md §11–§12, §23 |
