...
source_docs:
  - "MD files/1 Foundation/3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4, §61, §62"
  - "MD files/1 Foundation/1 PFF-FA-AI-ARCHITECTURE.md §2.1, §2.2"
  - "MD files/1 Foundation/2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §5.1, §5.2, §5.3"
build_phases: [0, 21]
impacted_paths:
  - src/pff_fa_ai/
...
3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4 provides an executive responsibility matrix across forty capabilities. It is the most
...
anyone whose incident it is. 20.PFF-FA-AI-GOVERNANCE.md §9 is explicit that no production AI component should be
ownerless, and a jointly-owned capability with no boundary definition is functionally
ownerless.

There is a second problem. 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4 is a *responsibility* matrix organised by technical
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Every capability must have a single accountable owner | 20.PFF-FA-AI-GOVERNANCE.md §9 |
| DR-F-02 | "Shared" must have an operational definition, not just a label | 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4 |
...
| DR-F-05 | Ownership must map to real teams | 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §62 |
...
| DR-N-02 | The map must remain stable as workflows are added | New workflow adds a business capability, not a new ownership class | 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §49 |
...
|---|---|---|---|
| DR-C-01 | 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4's authority column is binding and not open to reinterpretation | Organisational | 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4 |
| DR-C-02 | Enterprise owns every business capability's authority; the AI owns none | Platform | ADR-D1-01 §7.2 |
| DR-C-03 | 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §62's five-team logical model is the ownership vocabulary | Organisational | 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §62 |

### 3.4 Assumptions

| ID | Assumption | If false | Validation |
|---|---|---|---|
| DR-A-01 | 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §62's logical teams map onto real organisational teams | Ownership is nominal and incidents route badly | Confirmed with the Business Owner before Phase 23 |
...
| EC-02 | Fidelity to 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4 | 25 | The specification's authority assignments are binding (DR-C-01) | Does the model preserve every authority assignment? |
...
### 5.1 Option A — Adopt 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4 unchanged
...
- Loses 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4's authority nuance (EC-02) — the matrix distinguishes owning an operation
...
**Strengths.**
- Preserves 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4's authority assignments exactly (EC-02).
...
**Description.** Extend 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §61's RACI across all forty capabilities and use that as the map.
...
- Duplicates 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §61, which already exists for delivery capabilities.
...
| EC-02 Fidelity to 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4 | 25 | 5 | 2 | 5 | 4 |
...
382 is respectable and fails on EC-02: it would require overriding 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4's authority
...
side. 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4's authority column already says this; §7.1 makes it operative.
...
3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §62's five logical teams map to the three classes:

| Class | 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §62 team |
|---|---|
...
**Status rationale.** Accepted. Tier 1 under ADR-D0-03 §7.1 — data ownership is one of 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md
...
- Every capability has an accountable owner, satisfying 20.PFF-FA-AI-GOVERNANCE.md §9 for capabilities as well as
  components.
- "Shared" is operationally defined, so a quarter of 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4's map stops being ambiguous.
...
- Preserves 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4's authority column unchanged; this is a clarification, not a revision.
- 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §62's team model is adopted as-is, including its own caveat about mapping to real
  teams.
...
| Self-evident labels | Precision in the one place 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4 was ambiguous | AI Platform Owner |
...
| Audit and evidential requirements | Provides the ownership evidence 20.PFF-FA-AI-GOVERNANCE.md §9 requires and the accountability basis for §60 (Data Lineage). |
...
| Repository paths | Reflected in the package structure of `src/pff_fa_ai/` — AI-owned capabilities each have a package |
...
|---|---|---|
| AC-01 | Every capability in 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4 appears in exactly one class in §7.1 | Cross-check against 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4 |
...
| AC-06 | Every AI-owned capability corresponds to a package in `src/pff_fa_ai/` | Structure audit against `DEVELOPMENT-GUIDE.md` §3 |
...
| RT-04 | 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4 or §62 amended | Change notice | Re-derive §7.1 and §7.4 |
...
| Specification sections | 3. PFF-FA-AI-RESPONSIBILITY-MATRIX.md §4 (Executive Responsibility Matrix), §61 (Responsibility RACI), §62 (Team Boundary Model); 1 PFF-FA-AI-ARCHITECTURE.md §2.1–§2.2; 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §5.1–§5.3 |
| Requirement IDs | Per ADR-D1-12 |
| Build phases | 0, 21 |
| Code paths | Package structure of `src/pff_fa_ai/` |
