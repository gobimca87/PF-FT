...
source_docs:
  ...
  - "MD files/1 Foundation/2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §49"
...
7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §6 lists seven example agents — `AffiliationAgent`, `RegistrationAgent`,
...
Foundation documents list a different set of eight capabilities, 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md lists these seven, and
...
The seven names in 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §6 are *examples of workflow-level granularity*, offered to illustrate
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Candidate workflows must be recorded so design can generalise appropriately | 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §49 |
...
| DR-F-04 | Workflow granularity must follow "one agent = one business interaction" | 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §7 |
...
| DR-N-02 | Adding a candidate must not require redesign | Catalogue is data, not architecture | 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §49 |
...
| DR-C-02 | The agent catalogue is genuinely unfinalised and must not be invented | Organisational | 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §6; `DEVELOPMENT-GUIDE.md` §2 |
...
- When the question does arise, it arises with no criteria, so the choice is made ad hoc
  (EC-03).
- Loses the specification's own information: 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §6's seven examples and the Foundation
  documents' eight are real signal about the domain even if not a plan.

**Cost / effort.** Nil.

### 5.2 Option B — Committed roadmap of the seven 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md agents

**Description.** Adopt 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §6's list as the delivery plan, sequenced across releases.
...
**Weaknesses.**
- Directly contradicts DR-C-02. 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §6 says the catalogue will be finalised separately;
...
granularity per 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §7. For each, record what is known, what is unknown, and its enterprise
...
Reconciled from 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §6's seven examples and the Foundation documents' eight capabilities, at
the granularity 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §7 requires — one agent per business interaction, not per API.
...
| **Courses and accreditation** | Book and complete courses | `get_courses` appears in 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §7's tool example | Course catalogue, booking, certification | Unassessed |
...
catalogue, which remains open per 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §6 and is tracked in ADR-D1-11.
...
Workflows and agents are not the same thing, and conflating them is how the 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §6 list came
to look like a plan.
...
| Granularity | One business interaction (7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §7) | One workflow, per 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §6 |
...
`DEVELOPMENT-GUIDE.md` §2 flags that the Foundation documents and 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md list different sets.
§7.2 reconciles them by mapping to business interactions rather than choosing between the
lists:

| Foundation list | 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §6 list | §7.2 candidate |
|---|---|---|
...
| Audit and evidential requirements | Records that the catalogue was deliberately left open per 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §6, which is itself the evidence that it was not invented. |
...
| Specification sections | 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §6 (Workflow-Level Agent Responsibility — the seven examples and the "finalized separately" note), §7 (Why Workflow-Level Agents); 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §49 (Architecture Extension Model); `DEVELOPMENT-GUIDE.md` §2 (reconciliation item 2); affiliation flow |
| Requirement IDs | Per ADR-D1-12 |
| Build phases | 23; informs 4–11 |
| Code paths | Workflow-parameterised components across `src/pff_fa_ai/` |
