...
Doc 15 §37–§39 make structured output a principle and require output validation;
§40 states the SLM must not execute business rules; doc 16 §42–§44 cover output
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Machine-consumable outputs conform to a schema | doc 15 §37–§38; doc 16 §43 |
| DR-F-02 | Every structured output validated before use | doc 15 §39 |
| DR-F-03 | Invalid output handled (repair/retry/fail), never trusted | doc 15 §39; ADR-D3-04 |
| DR-C-01 | SLM output is data, not a business decision | doc 15 §40 |
...
**Method.** Weighted scoring against §4, informed by doc 15 §37–§42 and doc 16
...
executes business rules (doc 15 §40).

**Status rationale.** `Accepted` — doc 15 §37–§40 mandate structure+validation.
...
- Structured tasks pinned to temperature 0 (ADR-D3-16); streaming disabled for
  structured output unless the provider supports valid streamed structure (doc 15
  §48; ADR-D3-19).
...
| Specification sections | doc 15 §37–§42, §48; doc 16 §42–§44 |
