...
source_docs:
  - "MD files/2 Agent Runtime/7 PF-FT-AI-AGENTIC-ORCHESTRATION.md §12, §13, §29, §30, §68, §69"
  - "MD files/1 Foundation/2. PF-FT-AI-ARCHITECTURE-DETAILED.md §3.3"
  - "MD files/1 Foundation/3. PF-FT-AI-RESPONSIBILITY-MATRIX.md §46"
build_phases: [4]
impacted_paths:
...
|---|---|
| Build phases | 4 |
| Repository paths | `src/pf_ft_ai/orchestration/` — node classification and rules |
