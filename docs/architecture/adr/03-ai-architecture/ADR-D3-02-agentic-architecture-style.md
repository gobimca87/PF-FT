...
source_docs:
  - "MD files/2 Agent Runtime/7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §2, §3, §4, §5, §6, §7, §10, §11, §67, §68, §69, §72, §73"
  - "MD files/1 Foundation/1 PFF-FA-AI-ARCHITECTURE.md §9, §10, §11"
  - "MD files/1 Foundation/2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §3.7, §48"
build_phases: [4]
impacted_paths:
...
7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §3 gives the agentic orchestration model, §4 names four core components, §5 the supervisor's
responsibility, §6–§7 workflow-level agents and why. 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §11 gives the supervisor-to-agent flow.
7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §67–§69 draw reasoning and deterministic control boundaries; §72–§73 cover the agent loop
and its protection. 1 PFF-FA-AI-ARCHITECTURE.md §9–§11 place supervisor, agents and harness. 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §3.7 requires
...
- **Supervisor-routed.** One supervisor selects one agent; that agent executes a bounded graph.
  This is what 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §11's flow diagram shows.
...
7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §11's diagram implies the first. Nothing explicitly forecloses the others, and each is
something a competent engineer might build when asked for an "agentic AI platform" — the industry
term is used for all four.

The distinction matters for a specific reason that 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §73's loop protection hints at without
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | The supervisor routes to a workflow agent | 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §5, §11; 1 PFF-FA-AI-ARCHITECTURE.md §39 criterion 2 |
| DR-F-02 | An agent owns one end-to-end workflow capability | 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §6–§7; 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §3.7 |
| DR-F-03 | Agent execution must be bounded and loop-protected | 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §72–§73; 4. PFF-FA-AI-RUNTIME.md §54 |
| DR-F-04 | The reasoning boundary must be enforceable | 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §67–§69 |
| DR-F-05 | Agents must not bypass tools or override authorization | 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §5 |
...
|---|---|---|---|---|
| EC-01 | Boundedness of a turn's work | 30 | An unbounded turn is unbounded cost, latency and enterprise load; 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §73 requires protection | Is there a deterministic ceiling? |
...
- Matches 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §11's flow exactly.
...
- Planning across capabilities means the model sequences enterprise operations, which ADR-D2-08
  §5.2 rejected and 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §3.3 forbids for critical controls.
...
7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §67–§69's reasoning boundary is the same distinction: the agent reasons about *interpretation
...
1. The supervisor detects multiple candidate workflows and **clarifies** (ADR-D2-05 §7.4, 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md
...
3. The second remains available; the conversation may reach it in a later turn, with its own
   workflow instance associated to the same conversation (6 PFF-FA-AI-CONVERSATION-SESSION.md §23).

This is sequential rather than composed, and it is the honest handling: 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §14 is explicit that
...
7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §72's agent loop — gather context, reason, select a tool, execute, validate, check
...
**Status rationale.** Accepted. Tier 1 under ADR-D0-03 §7.1 — agent architecture is a named 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md
...
7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §67–§69's boundary, applied to the affiliation agent:
...
- Matches 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §11's flow, which is the specification's own diagram.
...
| Repository paths | `src/pff_fa_ai/orchestration/`, `src/pff_fa_ai/agents/` |
...
| Specification sections | 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §2–§4 (Core Principle, Orchestration Model, Four Core Components), §5 (Supervisor Responsibility), §6–§7 (Workflow-Level Agents, Why), §10 (Enterprise Workflow Boundary), §11 (Supervisor-to-Agent Flow), §14 (Clarification), §67–§69 (Reasoning Boundary, Deterministic Control Boundary, AI Reasoning Boundary), §72–§73 (Agent Loop, Loop Protection); 1 PFF-FA-AI-ARCHITECTURE.md §9–§11, §39 criterion 2; 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §3.3, §3.7, §48; 6 PFF-FA-AI-CONVERSATION-SESSION.md §23 |
| Requirement IDs | `FR-A39-02`, `FR-A39-03`, `NFR-A38-SEC` |
| Build phases | 4 |
| Code paths | `src/pff_fa_ai/orchestration/`, `src/pff_fa_ai/agents/` |
