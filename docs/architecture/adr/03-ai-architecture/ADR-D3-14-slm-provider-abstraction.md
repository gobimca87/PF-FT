...
(doc 15 §13–§15) — so that Hugging Face, self-hosted vLLM/TGI, or any future
...
Doc 15 §6 mandates an SLM provider abstraction, §7 lists provider implementations,
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | One interface for all providers | doc 15 §6, §15 |
| DR-F-02 | Provider/model fallback support | doc 15 §62–§63; ADR-D3-18 |
| DR-F-03 | Model allowlist + endpoint restriction enforced at the boundary | doc 15 §121–§123 |

### 3.2 Non-functional drivers

| ID | Driver | Target | Source |
|---|---|---|---|
| DR-N-01 | Provider swap without domain code change | 0 domain edits | doc 15 §15; ADR-D3-13 |
| DR-N-02 | Boundary-typed contracts | Pydantic req/res | CLAUDE.md; doc 15 §13–§14 |
...
| DR-C-02 | Only allowlisted models/endpoints callable | Security | doc 15 §121–§123 |
...
| EC-04 | Security enforceability (allowlist/endpoint) | 16 | doc 15 §121–§123 | Enforced at boundary |
...
**Method.** Weighted scoring against §4, informed by doc 15 §6–§15 and layering
rule ADR-D2-01.
...
model allowlist and endpoint restrictions (doc 15 §121–§123) at the boundary and
...
**Status rationale.** `Accepted` — mandated by doc 15 §6/§15 and ADR-D2-01.
...
- **Contracts** (doc 15 §13–§14): `SLMRequest` (messages, params, model id,
...
- **Policy** (doc 15 §121–§123): allowlist + endpoint check enforced before any call;
  non-allowlisted model raises `ModelError`.
- **Fallback** (doc 15 §62–§63; ADR-D3-18): the abstraction implements ordered
...
| Specification sections | doc 15 §6, §7, §13–§16, §56–§58, §62–§63, §121–§123 |
