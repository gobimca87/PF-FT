...
source_docs:
  - "MD files/2 Agent Runtime/7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §45, §46, §47, §49, §70"
  - "MD files/3 Context & Integration/10 PFF-FA-AI-ENTERPRISE-INTEGRATION.md §30, §31, §32, §33, §34, §35, §36, §37"
  - "MD files/4 AI/15.PFF-FA-AI-SLM.md §41, §42"
  - "MD files/4 AI/18.PFF-FA-AI-GUARDRAILS.md §38, §39, §40, §41"
build_phases: [6, 11]
impacted_paths:
...
7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §45 covers the tool node, §46 the tool allow-list, §47 tool authorization, §49 tool result
normalisation, §70 tool call validation. 10 PFF-FA-AI-ENTERPRISE-INTEGRATION.md §30–§37 cover selection, the selection boundary,
the executor and what it must not do, the execution lifecycle, input and output validation, and
the tool result contract. 15.PFF-FA-AI-SLM.md §41–§42 cover tool calling and tool call validation from the SLM
side. 18.PFF-FA-AI-GUARDRAILS.md §38–§41 cover tool restrictions, authorization, parameter validation and the tool
parameter guardrail.
...
outside the user's scope. 18.PFF-FA-AI-GUARDRAILS.md §40's parameter validation and §41's parameter guardrail exist for
this, and 12 PFF-FA-AI-PORTAL-LINKS.md §42's entity ownership validation addresses the analogous case for links — but
the tool path's equivalent is not stated as a distinct gate anywhere.

There are two further gaps. 10 PFF-FA-AI-ENTERPRISE-INTEGRATION.md §33 lists what the executor must not do without stating the
positive sequence. And 15.PFF-FA-AI-SLM.md §42 requires tool call validation without saying whether a malformed
proposal is repaired, retried or refused — 18.PFF-FA-AI-GUARDRAILS.md §55's "output repair" suggests repair is
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Tools must be allowlisted per agent | 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §46; 18.PFF-FA-AI-GUARDRAILS.md §38 |
| DR-F-02 | Tool calls must be authorized from claims | 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §47; 18.PFF-FA-AI-GUARDRAILS.md §39 |
| DR-F-03 | Tool parameters must be validated | 10 PFF-FA-AI-ENTERPRISE-INTEGRATION.md §35; 18.PFF-FA-AI-GUARDRAILS.md §40–§41 |
| DR-F-04 | Tool results must be validated | 10 PFF-FA-AI-ENTERPRISE-INTEGRATION.md §36; 18.PFF-FA-AI-GUARDRAILS.md §46 |
| DR-F-05 | Tool results must be normalised to a contract | 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §49; 10 PFF-FA-AI-ENTERPRISE-INTEGRATION.md §37 |
| DR-F-06 | The executor must not do what 10 PFF-FA-AI-ENTERPRISE-INTEGRATION.md §33 forbids | 10 PFF-FA-AI-ENTERPRISE-INTEGRATION.md §33 |
...
| DR-N-02 | Every gate decision must be traceable | 100% logged | 20.PFF-FA-AI-GOVERNANCE.md §29 |
...
| DR-C-03 | The SLM never receives unrestricted API access | Platform | 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §3.4 |
...
| EC-02 | Prevention of unpermitted tool execution | 25 | 2. PFF-FA-AI-ARCHITECTURE-DETAILED.md §3.4 and ADR-D1-02 I-3 make this categorical | Can an unallowlisted tool execute? |
...
- Defence in depth is abandoned: 18.PFF-FA-AI-GUARDRAILS.md §5 requires layered defence, and relying solely on the
...
- 18.PFF-FA-AI-GUARDRAILS.md §5's defence-in-depth principle argues against single-mechanism reliance.
...
implied by 18.PFF-FA-AI-GUARDRAILS.md §40–§41 and 12 PFF-FA-AI-PORTAL-LINKS.md §42's analogue but is not stated as a distinct step, and it is
...
18.PFF-FA-AI-GUARDRAILS.md §5's defence in depth is the principle; gate 3 is the second layer.
...
This is ADR-D1-02 invariant I-2 at the tool boundary, and 10 PFF-FA-AI-ENTERPRISE-INTEGRATION.md §33's prohibition on the executor
...
|---|---|---|---|
| **6** | **Result schema validation** | The response satisfies the tool's response contract (10 PFF-FA-AI-ENTERPRISE-INTEGRATION.md §36; ADR-D2-15 §7.3) | Treated as a failed call; no defaulting |
...
7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §49's result normalisation happens after gate 6: the validated response is mapped to the
tool's result contract and to ERC shapes (ADR-D2-12 §7.2).

### 7.5 A rejected call is an outcome, not an error

15.PFF-FA-AI-SLM.md §42 requires tool call validation; 18.PFF-FA-AI-GUARDRAILS.md §55 mentions output repair. Repairing a tool call
...
flowchart TD
    ...
    G7 --> N[Normalise to result contract<br/>7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §49]
...
| Simplicity of trusting the enterprise to refuse | Defence in depth per 18.PFF-FA-AI-GUARDRAILS.md §5 | External ADF/ADR forum |
...
| Repository paths | `src/pff_fa_ai/integration/tools/executor.py`, `validator.py`, `policy.py` |
...
| Specification sections | 7 PFF-FA-AI-AGENTIC-ORCHESTRATION.md §45 (Tool Node), §46 (Tool Allow-List), §47 (Tool Authorization), §49 (Tool Result Normalization), §70 (Tool Call Validation); 10 PFF-FA-AI-ENTERPRISE-INTEGRATION.md §30–§37 (Selection, Selection Boundary, Executor, Executor Must Not, Execution Lifecycle, Input Validation, Output Validation, Result Contract), §33; 15.PFF-FA-AI-SLM.md §41–§42 (Tool Calling, Tool Call Validation); 18.PFF-FA-AI-GUARDRAILS.md §5 (Defense in Depth), §38–§41 (Tool Restrictions, Authorization, Parameter Validation, Parameter Guardrail), §46 (API Response Validation), §55 (Output Repair); 12 PFF-FA-AI-PORTAL-LINKS.md §42 (Entity Ownership Validation) |
| Requirement IDs | `FR-A39-07`, `FR-A39-11`, `NFR-A38-SEC` |
| Build phases | 6, 11 |
| Code paths | `src/pff_fa_ai/integration/tools/` |
