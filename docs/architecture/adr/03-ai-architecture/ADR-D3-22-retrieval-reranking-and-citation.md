...
source_docs:
  - "MD files/4 AI/13.PFF-FA-AI-RAG.md §51, §52, §53, §54, §63, §64, §65, §66, §67, §68, §69, §70, §71, §81, §82, §83, §88, §89, §90, §91, §92"
build_phases: [8]
impacted_paths:
...
(13.PFF-FA-AI-RAG.md §51–§71, §81–§92). Below the score threshold, the platform says it doesn't
...
13.PFF-FA-AI-RAG.md §51–§54 define vector/keyword/hybrid retrieval and why hybrid; §63–§71 cover
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | High recall + precision on knowledge queries | 13.PFF-FA-AI-RAG.md §53–§54, §65 |
| DR-F-02 | Exact-identifier retrieval | 13.PFF-FA-AI-RAG.md §52 (keyword); ADR-D3-23 |
| DR-F-03 | Every claim cited or not made | 13.PFF-FA-AI-RAG.md §81, §82, §88, §91 |
| DR-F-04 | Low-confidence/no-result handled honestly | 13.PFF-FA-AI-RAG.md §69–§71 |
| DR-C-01 | ACL filtering before/at retrieval | 13.PFF-FA-AI-RAG.md §61–§62; ADR-D6-12 |
...
| EC-05 | Latency | 12 | Within budget (13.PFF-FA-AI-RAG.md §88) | p95 retrieval |
...
**Description.** Vector + BM25 candidates, fused (13.PFF-FA-AI-RAG.md §64), reranked (§65–§67),
...
**Weaknesses.** Permits unsupported claims — violates 13.PFF-FA-AI-RAG.md §82; the core risk.
**Cost / effort.** Low; unsafe.

### 5.5 Option E — Agentic multi-hop retrieval (query planning + iterative retrieval)

**Description.** Decompose queries, retrieve iteratively (13.PFF-FA-AI-RAG.md §108–§113).
...
**Method.** Weighted scoring against §4, informed by 13.PFF-FA-AI-RAG.md §51–§92 and the corpus
...
claim maps to a cited chunk (13.PFF-FA-AI-RAG.md §83) and citations are validated (§91); below the
...
**Status rationale.** `Accepted` — 13.PFF-FA-AI-RAG.md §51–§92 govern this; ADR records rationale.

## 8. Architecture Detail

- **Pipeline** `src/pff_fa_ai/rag/retrieval/`: ACL filter (ADR-D6-12) → hybrid search
...
|---|---|
| Build phases | 8 |
| Repository paths | `src/pff_fa_ai/rag/retrieval/` |
...
| Specification sections | 13.PFF-FA-AI-RAG.md §51–§71, §81–§92, §127–§135 |
| Requirement IDs | RAG-RET-* |
| Build phases | 8 |
| Code paths | `src/pff_fa_ai/rag/retrieval/` |
