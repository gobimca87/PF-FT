...
source_docs:
  - "MD files/4 AI/15.PFF-FA-AI-SLM.md §61, §62, §63, §64, §65, §66, §67, §68, §69, §163, §168"
build_phases: [6]
impacted_paths:
  - src/pff_fa_ai/slm/
...
15.PFF-FA-AI-SLM.md §62–§64 require fallback that is compatible and **not silent**; §65–§69 define
...
**Description.** The full pattern from 15.PFF-FA-AI-SLM.md §61–§69: try primary; on failure/timeout
...
**Method.** Weighted scoring against §4, informed by 15.PFF-FA-AI-SLM.md §61–§69/§163/§168 and
...
- Implemented in the SLM abstraction (ADR-D3-14): a resilience wrapper around
  ...
  circuit-breaker per provider (15.PFF-FA-AI-SLM.md §67).
...
| Specification sections | 15.PFF-FA-AI-SLM.md §61–§69, §163, §168 |
