...
(ADR-D6-15) (doc 17 §42–§43, §56–§58; doc 15 §151–§159; doc 16 §102–§103, §155–§156). AI
artefacts follow the same rigor as code, with AI-specific promotion mechanics.

## 2. Context and Problem Statement

Doc 17 §42–§43 RAG version deps/compatibility, §56–§58 dependency + release manifest; doc
15 §151–§159 model promotion/release/shadow/canary/rollback; doc 16 §102–§103/§155–§156
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Version all AI artefacts (Git) | ADR-D3-11/D3-15; doc 17 |
| DR-F-02 | Promote as compatible bundles | doc 17 §56–§58 |
| DR-F-03 | AI-specific promotion (shadow/canary/blue-green) | doc 15 §157–§158; doc 14 §77 |
...
|---|---|---|---|
| DR-A-01 | Artefact compatibility is expressible | Compatibility matrix (doc 17 §43) | Review |
...
compatible versions with a compatibility matrix (doc 17 §43); eval gate (ADR-D7-13);
shadow→canary for models (doc 15 §157–§158), blue/green for indexes (doc 14 §77); under
...
| No eval before promotion | doc 20 §86; ADR-D7-13 |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by doc 17 §42–§58, doc 15 §151–§159, doc
16 §102–§103/§155–§156.
...
- Artefact registries: prompts (ADR-D3-11), models (ADR-D3-15), RAG index/embedding
  ...
  compatibility matrix (doc 17 §43, §132).
- Promotion: eval gate (ADR-D7-13) → shadow eval (doc 15 §157) → canary (doc 15 §158;
  ADR-D7-10) for models/prompts; blue/green alias swap for indexes (doc 14 §77); rollback
  per artefact (doc 15 §159; doc 16 §103; doc 28 §44–§47).
...
| RSK-03 | Index cutover breaks retrieval | Low | High | M | Blue/green alias (doc 14 §77) | AI Arch Lead | Low |
...
| Data classification touched | Internal; eval datasets governed (doc 20 §84) |
...
| Runbook | `docs/runbooks/llmops.md` (doc 28 §44–§47) |
| Failure mode and degradation | Regression → auto-rollback |
| Rollback | Per-artefact/bundle (doc 15 §159) |
...
| Specification sections | doc 17 §42–§43, §56–§58, §132; doc 15 §151–§159; doc 16 §102–§103, §155–§156 |
