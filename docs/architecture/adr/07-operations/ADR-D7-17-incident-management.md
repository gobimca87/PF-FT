...
source_docs:
  - "MD files/6 Production/28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §8, §9, §10, §11, §12, §13, §14, §15, §105, §106"
  - "MD files/5 QualityGovernance/20.PFF-FA-AI-GOVERNANCE.md §105, §106"
build_phases: [10]
impacted_paths:
  - docs/runbooks/
...
post-incident review feeding causal analysis (28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §8–§15, §105–§106; 20.PFF-FA-AI-GOVERNANCE.md §105–§106).
AI incidents are first-class, not shoehorned into infra categories.

## 2. Context and Problem Statement

28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §8–§12 severity (P1–P4), §13 incident lifecycle, §14 first-response checklist, §15
incident evidence, §105–§106 governance incident/process; 20.PFF-FA-AI-GOVERNANCE.md §105–§106 AI governance
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Standard lifecycle + P1–P4 + evidence | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §8–§15 |
| DR-F-02 | AI-specific incident classes | 20.PFF-FA-AI-GOVERNANCE.md §105–§106; 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §105–§106 |
| DR-F-03 | Blameless review → causal analysis | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §13; ADR-D6-13 (CAR) |
| DR-C-01 | Evidence capture (audit) | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §15; ADR-D6-17 |
...
**Description.** The 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md lifecycle with P1–P4; add AI incident classes (hallucination,
...
**Weaknesses.** Recurrence; no causal learning (20.PFF-FA-AI-GOVERNANCE.md §106).
...
|---|---|
| No incident process | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §13 |
| No evidence capture | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §15 |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §8–§15/§105–§106 and 20.PFF-FA-AI-GOVERNANCE.md
§105–§106.
...
- Lifecycle (28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §13): detect→triage→mitigate→resolve→review; first-response checklist
...
| Rollback | AI rollback (ADR-D7-12; 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §44–§47) |
...
| Specification sections | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §8–§15, §105–§106; 20.PFF-FA-AI-GOVERNANCE.md §105–§106 |
| Requirement IDs | INC-* |
| Build phases | 10 |
