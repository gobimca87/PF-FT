...
**P1–P4 severity model** with an **on-call escalation path** (doc 24 §49, §53; doc 28
...
Doc 24 §49 metrics, §53 error severity; doc 28 §8–§13 operational severity (P1–P4) and
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Alert on symptoms/SLO burn + severities | doc 24 §49, §53; ADR-D7-07 |
| DR-F-02 | P1–P4 severity + escalation | doc 28 §8–§13 |
...
(ADR-D7-05); map to P1–P4 (doc 28 §9–§12); escalation path per severity; every alert
...
| No severity model | doc 28 §8 |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by doc 24 §49/§53 and doc 28 §8–§13.
...
- Alert rules in Azure Monitor (ADR-D7-01) on SLO burn (ADR-D7-07) + severity from the
  error catalogue (ADR-D7-05); P1–P4 mapping (doc 28 §9–§12); escalation to on-call per
...
- Correlation/dedup groups related alerts; security alerts (e.g. ADR-D6-08/D6-12) route
  to security on-call; incident lifecycle per doc 28 §13 and ADR-D7-17.
...
| Specification sections | doc 24 §49, §53; doc 28 §8–§13 |
