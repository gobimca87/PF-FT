...
AI artefacts into an immutable release (ADR-D5-06) (25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §65–§68; 17.PFF-FA-AI-CONFIGURATION-VERSIONING.md §58, §60).
Main is always releasable; releases are versioned, dated and traceable to a git commit.

## 2. Context and Problem Statement

25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §65–§68 CI/CD/PR-gate; 17.PFF-FA-AI-CONFIGURATION-VERSIONING.md §58 release manifest, §60 release id. Long-lived
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Protected, always-releasable main | 25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §68 |
| DR-F-02 | Semantic versioned, traceable releases | 17.PFF-FA-AI-CONFIGURATION-VERSIONING.md §58, §60 |
...
immutable manifest (ADR-D5-06) with git-commit association (17.PFF-FA-AI-CONFIGURATION-VERSIONING.md §60).
...
|---|---|
| No branch protection | 25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §68 |
| Unversioned releases | 17.PFF-FA-AI-CONFIGURATION-VERSIONING.md §58, §60 |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by 25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §65–§68 and 17.PFF-FA-AI-CONFIGURATION-VERSIONING.md §58/§60.
...
- Each release = an immutable manifest (ADR-D5-06) pinning code image digest (ADR-D5-09)
  ...
  association (17.PFF-FA-AI-CONFIGURATION-VERSIONING.md §60); promoted via CD (ADR-D7-10) through the ladder (ADR-D5-14).
...
| Specification sections | 25.PFF-FA-AI-INFRASTRUCTURE-OPERATIONS.md §65–§68; 17.PFF-FA-AI-CONFIGURATION-VERSIONING.md §58, §60 |
| Requirement IDs | REL-* |
| Build phases | 0 |
