...
(doc 23 §2–§4, §8–§12, §48–§49). Dev-time engineering agents are strictly separate from
the runtime AffiliationAgent (ADR-D1-11) and produce suggestions gated by the same CI/
governance as any human change.

## 2. Context and Problem Statement

Doc 23 §2–§4 principle/scope/architecture, §8–§9 change-impact analysis/selection, §11–§12
...
| ID | Driver | Source |
|---|---|---|
| DR-C-01 | Advisory only; never merge/deploy | doc 23 §11–§12, §16 |
| DR-C-02 | Least privilege | doc 23 §12 |
| DR-F-01 | Change-impact-based agent selection | doc 23 §8–§9 |
...
architecture compliance) run with least privilege (doc 23 §12), produce suggestions/PR
...
**Strengths.** Fastest.
**Weaknesses.** Unsafe; bypasses human authority/CI; doc 23 §16 forbids.
...
|---|---|
| Agents that bypass CI/review | doc 23 §16 |
| Agents with prod access | doc 23 §12 (least privilege) |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by doc 23 §2–§49.
...
- Engineering-agent supervisor (doc 23 §6–§7) selects agents by change-impact (§8–§9);
...
| Specification sections | doc 23 §2–§4, §8–§12, §16, §23, §35, §48–§49 |
