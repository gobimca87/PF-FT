...
source_docs:
  - "MD files/5 QualityGovernance/22.PFF-FA-AI-TESTING.md §5, §6, §7, §8, §10, §12, §20, §21, §30, §37, §38, §41, §50, §56"
build_phases: [1]
impacted_paths:
  - tests/
...
AI-dependent tests are stable and fast (22.PFF-FA-AI-TESTING.md §5–§8, §12, §20–§21, §37–§38). Non-
...
22.PFF-FA-AI-TESTING.md §5–§6 test pyramid/layers, §7–§8 categories/structure, §10–§12 unit principles/
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Test pyramid (unit-heavy) | 22.PFF-FA-AI-TESTING.md §5 |
| DR-F-02 | Deterministic mock SLM + mock enterprise APIs | 22.PFF-FA-AI-TESTING.md §12, §20–§21, §37 |
| DR-F-03 | Non-determinism tested at eval layer | ADR-D7-13 |
| DR-F-04 | Security/ACL/idempotency/isolation tests | 22.PFF-FA-AI-TESTING.md §41, §50, §56 |
...
contract-based enterprise-API mocks (22.PFF-FA-AI-TESTING.md §20–§21); component/integration for wiring;
...
|---|---|
| Non-deterministic model asserts in unit tests | 22.PFF-FA-AI-TESTING.md §12; flake |
| No security/ACL tests | 22.PFF-FA-AI-TESTING.md §41 |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by 22.PFF-FA-AI-TESTING.md §5–§56.
...
- `tests/` structured per 22.PFF-FA-AI-TESTING.md §8; a deterministic `MockSLMProvider` (ADR-D3-14) returns
  fixed outputs; enterprise-API mocks are contract-driven (22.PFF-FA-AI-TESTING.md §19–§21) with recorded
  fixtures; TypedDict/graph state tested (22.PFF-FA-AI-TESTING.md §30; ADR-D2-07).
- Security suites: prompt-injection/tool-abuse (22.PFF-FA-AI-TESTING.md §34/§45), RAG ACL (§41; ADR-D6-12),
...
| Specification sections | 22.PFF-FA-AI-TESTING.md §5–§8, §10–§12, §20–§21, §30, §37–§38, §41, §50, §56 |
