...
source_docs:
  - "MD files/6 Production/28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §2, §3, §4, §7, §16, §17, §29, §30, §161"
build_phases: [10]
impacted_paths:
  - docs/runbooks/
...
maintained runbook and an owner (28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §2–§4, §7, §16–§17, §29–§30, §161). Support tiers
and escalation are explicit.

## 2. Context and Problem Statement

28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §2–§4 operational principle/boundaries/responsibilities, §7 production access, §16
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Clear operational boundaries (AI vs enterprise) | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §3 |
| DR-F-02 | Owned, maintained runbooks | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §161 |
| DR-F-03 | Tiered support + on-call | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §4 |
| DR-C-01 | Controlled production access | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §7 |
...
with an owned runbook (28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §161), an on-call rota with escalation (ADR-D7-08), and
controlled/audited production access (28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §7); boundaries with PFF explicit (§3).
...
|---|---|
| No runbooks | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §161 |
| Uncontrolled prod access | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §7 |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §2–§4/§7/§16–§17/§161.
...
- Operational boundaries (28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §3): AI-platform team operates the AI layer; PFF owns
...
- On-call rota + escalation tied to severity (ADR-D7-08); production access is
  least-privilege, time-bound and audited (28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §7; ADR-D6-17). L3 escalation follows
...
| Specification sections | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §2–§4, §7, §16–§17, §29–§30, §161 |
