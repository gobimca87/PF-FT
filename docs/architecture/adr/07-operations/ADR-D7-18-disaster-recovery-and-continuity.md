...
source_docs:
  - "MD files/6 Production/28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §42, §43, §48, §49, §50"
  - "MD files/4 AI/14.PFF-FA-AI-EMBEDDING-VECTOR.md §85, §86, §136, §137"
  - "MD files/4 AI/13.PFF-FA-AI-RAG.md §186"
build_phases: [21]
impacted_paths:
  - docs/runbooks/
...
from Git + manifest (ADR-D5-06); the RAG index rebuilds from canonical documents (14.PFF-FA-AI-EMBEDDING-VECTOR.md
§85–§86; 13.PFF-FA-AI-RAG.md §186); only conversation/session/memory state (Redis, ADR-D4-10) needs
backup/replication (28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §42–§50). Continuity favours graceful degradation over hard
downtime.

## 2. Context and Problem Statement

28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §42–§43 rollback, §48–§50 SLM/self-hosted-SLM failure procedures; 14.PFF-FA-AI-EMBEDDING-VECTOR.md §85–§86
canonical data/rebuild, §136–§137 DR/rebuild strategy; 13.PFF-FA-AI-RAG.md §186 final RAG architecture
...
| DR-F-02 | Reconstruct code/config/artefacts/index | ADR-D5-06; 14.PFF-FA-AI-EMBEDDING-VECTOR.md §86; 13.PFF-FA-AI-RAG.md §186 |
| DR-C-01 | Backup/replicate genuinely stateful data | ADR-D4-10 |
| DR-F-03 | Graceful degradation for dependency loss | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §48–§50; ADR-D3-18 |
...
manifest; RAG index rebuilds from canonical docs (14.PFF-FA-AI-EMBEDDING-VECTOR.md §86); conversation/session/memory
...
**Method.** Weighted scoring against §4, informed by 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §42–§50, 14.PFF-FA-AI-EMBEDDING-VECTOR.md §85–§86/§136–
§137, 13.PFF-FA-AI-RAG.md §186.
...
- RPO/RTO table per data class: enterprise data (PFF-owned, their BC); AI code/config/
  ...
  docs, RTO=rebuild time, 14.PFF-FA-AI-EMBEDDING-VECTOR.md §86); conversation/session/memory (RPO from Redis
  backup/geo-replica, ADR-D4-10).
- Long-running workflows resume from durable state (ADR-D2-10); dependency loss →
  degraded mode (ADR-D3-18; 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §48–§50); DR runbooks (28.PFF-FA-AI-OPERATIONS-RUNBOOK.md) + scheduled game-days
  validate RTO/RPO.
- Region failover procedure documented; index rebuild automated (14.PFF-FA-AI-EMBEDDING-VECTOR.md §137; 13.PFF-FA-AI-RAG.md
  §186).
...
| Specification sections | 28.PFF-FA-AI-OPERATIONS-RUNBOOK.md §42–§50; 14.PFF-FA-AI-EMBEDDING-VECTOR.md §85–§86, §136–§137; 13.PFF-FA-AI-RAG.md §186 |
| Requirement IDs | DR-* |
| Build phases | 21 |
