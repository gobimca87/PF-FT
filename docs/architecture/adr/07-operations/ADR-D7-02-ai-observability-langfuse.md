...
the platform stack (ADR-D7-01) (doc 24 §15, §23–§27, §42–§48, §50; CLAUDE.md). Langfuse
is for AI observability, **not** the tamper-evident audit record (ADR-D6-17), and its
traces are redacted of sensitive data.

## 2. Context and Problem Statement

Doc 24 §15 AI observability, §23–§24 prompt observability/version traceability, §25–§27
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Trace LLM/agent/prompt/token/cost | doc 24 §15, §23–§27 |
| DR-F-02 | Prompt-version traceability | doc 24 §24; ADR-D3-11 |
| DR-C-01 | Redact sensitive data in traces | doc 24 §14; ADR-D7-04 |
...
|---|---|
| No AI observability | doc 24 §15 |
| Langfuse as the audit record | ADR-D6-17 (separate concern) |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by doc 24 §15/§42–§48 and CLAUDE.md.
...
| Aspect | Detail |
|---|---|
| Monitoring | Langfuse health (doc 28 §39); trace volume |
...
| Specification sections | doc 24 §15, §23–§27, §42–§48, §50 |
