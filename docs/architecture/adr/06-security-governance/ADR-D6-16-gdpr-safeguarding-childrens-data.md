...
source_docs:
  ...
  - "MD files/5 QualityGovernance/20.PFF-FA-AI-GOVERNANCE.md §26, §98"
build_phases: [9, 12]
impacted_paths:
  - docs/governance/
...
and never used to profile or make automated significant decisions about a child (19.PFF-FA-AI-SECURITY.md
§31–§34; 20.PFF-FA-AI-GOVERNANCE.md §26, §98; UK GDPR). Where the spec is silent, this ADR mandates a DPIA to
close the gap.

## 2. Context and Problem Statement

19.PFF-FA-AI-SECURITY.md §31–§34 cover PII/classification/data-flow/minimisation; 20.PFF-FA-AI-GOVERNANCE.md §26 privacy, §98
...
| DR-C-02 | Lawful basis + minimisation + retention | 19.PFF-FA-AI-SECURITY.md §34; UK GDPR Art. 5–6 |
...
**Method.** Weighted scoring against §4, informed by 19.PFF-FA-AI-SECURITY.md §31–§34, 20.PFF-FA-AI-GOVERNANCE.md §26/§98 and
...
- DPIA maintained in `docs/governance/`; rights (access/erasure/rectification) routed to
  the enterprise system of record (PFF as controller); retention limits enforced (9 PFF-FA-AI-MEMORY-CACHE.md
  §75).
...
| Specification sections | 19.PFF-FA-AI-SECURITY.md §31–§34; 20.PFF-FA-AI-GOVERNANCE.md §26, §98 |
