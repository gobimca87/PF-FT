...
defined schedule, and queryable for compliance evidence (doc 20 §29–§30, §71, §81, §99;
doc 5 §60; doc 6 §62). Audit is for accountability, not debugging.

## 2. Context and Problem Statement

Doc 20 §29–§30 traceability/auditability, §71 HIL evidence, §81 approval evidence, §99
compliance evidence; doc 5 §60 state-transition audit; doc 6 §62 conversation audit.
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Append-only, tamper-evident audit trail | doc 20 §30; doc 5 §60 |
| DR-F-02 | Capture decisions/consequential events | doc 20 §71, §81; doc 6 §62 |
| DR-C-01 | Redact unnecessary PII in audit | ADR-D7-04; UK GDPR |
| DR-F-03 | Defined retention + queryable evidence | doc 20 §99 |
...
|---|---|
| No audit trail | doc 20 §30 |
| Mutable audit records | Not evidential |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by doc 20 §29–§30/§71/§81/§99, doc 5
§60, doc 6 §62.
...
- Events: HIL (doc 20 §71; ADR-D6-14), approvals (§81; ADR-D6-15), authz decisions
  (ADR-D6-02/03), tool/enterprise actions, state transitions (doc 5 §60), RAG/ACL
  outcomes (ADR-D6-12), conversation audit (doc 6 §62).
...
| Specification sections | doc 20 §29–§30, §71, §81, §99; doc 5 §60; doc 6 §62 |
