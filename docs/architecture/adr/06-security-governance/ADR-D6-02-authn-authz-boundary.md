...
authorization decision** (doc 19 §10–§12, §16–§17; doc 18 §33–§35, §60; CLAUDE.md
Golden Rule). Authorization decisions that gate actions remain deterministic and
enterprise-owned.

## 2. Context and Problem Statement

Doc 19 §10–§12 define authentication, authorization and authorization context;
§16–§17 the APIM boundary and AI responsibilities; doc 18 §33–§35 the authorization
...
| ID | Driver | Source |
|---|---|---|
| DR-C-01 | AI consumes validated claims; never authenticates | CLAUDE.md; doc 19 §16–§17 |
| DR-C-02 | Model output is never an authz decision | doc 18 §60; CLAUDE.md |
| DR-C-03 | Authz context not user-controllable | doc 18 §35 |
| DR-F-01 | Deterministic authz enforcement | doc 19 §11 |
...
**Weaknesses.** Non-deterministic authz; model output as decision (doc 18 §60
...
|---|---|
| Trust user-supplied authz context | doc 18 §35 |
| Cache authz decisions long-term | Staleness/precedence risk |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by doc 19 §10–§17, doc 18 §33–§35/§60
and CLAUDE.md.
...
**Status rationale.** `Accepted` — CLAUDE.md and doc 19/18 mandate this.

## 8. Architecture Detail

- APIM validates JWT/claims (ADR-D5-15); the AI reads a validated authorization context
  (ADR-D6-03) that is not user-controllable (doc 18 §35).
- Any AI-side gate is deterministic code checking claims; the model may *explain* an
  authorization outcome but never *make* it (doc 18 §60); tool calls are gated by the
...
| Specification sections | doc 19 §10–§12, §16–§17; doc 18 §33–§35, §60 |
