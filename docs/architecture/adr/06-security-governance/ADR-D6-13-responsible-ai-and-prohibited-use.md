...
safety, privacy, transparency, explainability, traceability, auditability (doc 20
...
Doc 20 §21–§30 define Responsible AI principles and their scope; §13–§15 AI suitability
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Adopt the 8 RAI principles | doc 20 §21–§30 |
| DR-F-02 | Define a prohibited-use boundary | doc 20 §22, §14 |
| DR-C-01 | Principles enforced via controls, not text | ADR-D1-02, D6-09, D6-14 |
| DR-F-03 | Risk-classify AI uses | doc 20 §15–§17 |
...
dashboard (doc 20 §87–§89) with periodic governance review.
...
|---|---|
| No RAI framework | doc 20 §21 |
| RAI as marketing only | Not enforceable |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by doc 20 §13–§30/§87–§89.
...
- Prohibited-use list maintained in `docs/governance/`; out-of-scope intents refused
  (ADR-D3-06 closed intent set); risk classification (doc 20 §15–§17) gates new AI uses.
- RAI metrics (fairness proxies, quality, persona adherence, refusal correctness) on a
  governance dashboard (doc 20 §87–§89); periodic review (§90).
...
| Specification sections | doc 20 §13–§17, §21–§30, §87–§90 |
