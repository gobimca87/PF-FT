...
humans hold decision authority, and **HIL decisions are captured as evidence** (20.PFF-FA-AI-GOVERNANCE.md
§68–§71). HIL is a governed workflow state (ADR-D2-10), not an afterthought.

## 2. Context and Problem Statement

20.PFF-FA-AI-GOVERNANCE.md §68 human oversight, §69 HIL boundary, §70 human decision authority, §71 HIL
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Defined HIL boundary (when to pause) | 20.PFF-FA-AI-GOVERNANCE.md §69; ADR-D3-07 |
| DR-C-01 | Humans hold decision authority | 20.PFF-FA-AI-GOVERNANCE.md §70; ADR-D1-02 |
| DR-F-02 | HIL decisions captured as evidence | 20.PFF-FA-AI-GOVERNANCE.md §71; ADR-D6-17 |
...
evidence (20.PFF-FA-AI-GOVERNANCE.md §71; ADR-D6-17); resume on decision.
...
| HIL without evidence | 20.PFF-FA-AI-GOVERNANCE.md §71 |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by 20.PFF-FA-AI-GOVERNANCE.md §68–§71 and ADR-D3-07/D2-10.
...
- HIL evidence (who/role, decision, timestamp, context) recorded per 20.PFF-FA-AI-GOVERNANCE.md §71 and
...
| Specification sections | 20.PFF-FA-AI-GOVERNANCE.md §68–§71 |
