...
continuously rather than at audit time (doc 20 §98–§100). Conformance is treated as a
mapping-and-evidence exercise over the existing controls, not a parallel bureaucracy.

## 2. Context and Problem Statement

Doc 20 §98 lists the regulatory/compliance mapping (ISO/IEC 42001, 23894, 27001, 27701,
...
| ID | Driver | Source |
|---|---|---|
| DR-F-01 | Define target standards | doc 20 §98 |
| DR-F-02 | Map requirements → ADRs/controls | doc 20 §100 |
| DR-F-03 | Continuous evidence collection | doc 20 §99 |
...
**Weaknesses.** Can't demonstrate compliance; gaps invisible; doc 20 §99–§100 unmet.
...
obligations; doc 20 §98 lists several.
...
|---|---|
| No standards alignment | doc 20 §98 |
| Duplicate control set per standard | Inefficient; error-prone |

## 6. Evaluation Method and Decision Matrix

**Method.** Weighted scoring against §4, informed by doc 20 §98–§100.
...
- A compliance mapping (doc 20 §100) in `docs/governance/`: rows = requirements per
...
| Specification sections | doc 20 §98–§100 |
