...
| IaC tool | Phase 19 (Infrastructure) | Terraform, Bicep | **Open** |
| Kubernetes manifest tool | Phase 19 (Infrastructure) | Kustomize, Helm | **Open** |
| Deployment strategy | Phase 19 (Infrastructure) | Rolling, Blue-Green, Canary | **Open** |
